...
class pure_winter():
    def __init__(self):
        # barra因子数据
        self.barras = self.read_h5('/Users/chenzongwei/pythoncode/数据库/barra/FactorLoading_Style.h5')
        # 行业哑变量数据
        self.industrys = self.read_h5('/Users/chenzongwei/pythoncode/数据库/barra/FactorLoading_Industry.h5')
